...
import be.iminds.iot.dianne.rnn.learn.factory.RecurrentLearnerFactory;
import be.iminds.iot.dianne.tensor.Tensor;
import be.iminds.iot.dianne.tensor.TensorFactory;

@Component(property={"aiolos.unique=true"})
public class BPTTLearner implements RecurrentLearner {
	...
	protected Map<String, SequenceDataset> datasets = new HashMap<>();
	...
	public void learn(NeuralNetworkInstanceDTO nni, String dataset,
		...
		System.out.println("Recurrent Learner Configuration");
		System.out.println("===============================");
		...
		// Fetch the dataset
		SequenceDataset d = datasets.get(dataset);
		if(d==null){
		...
		processor = RecurrentLearnerFactory.createProcessor(factory, nn, d, config, logger);
	...
	void addDataset(SequenceDataset dataset, Map<String, Object> properties){
		String name = (String) properties.get("name");
		this.datasets.put(name, dataset);
	}
	
	void removeDataset(SequenceDataset dataset, Map<String, Object> properties){
		String name = (String) properties.get("name");
